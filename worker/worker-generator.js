...
const jsURL = 'https://raw.githubusercontent.com/DSnewbie24/G-Drive-Index/master/worker/worker-beta.js';

async function handleRequest(request) {
    let title = getParameterByName(request.url, 'site_name') || 'Placebo Drive Index';
...
<head>
    ...
    <title>Placeboo Drive Index - Beta</title>
...
<div class="container">
    <br><br>
    <a href="https://www.npmjs.com/package/@googledrive/index"><h3>Placeboo Index Generator - Beta</h3></a>
    <br>
        <div>
            <h3>1. <a
